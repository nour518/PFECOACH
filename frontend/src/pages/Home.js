...
const Home = () => {
    ...
    // Référence pour la section "Coachs"
    const coachesRef = useRef(null);

    // Fonction pour faire défiler la page vers la section "Coachs"
    const scrollToCoaches = () => {
        if (coachesRef.current) {
            coachesRef.current.scrollIntoView({ behavior: "smooth" }); // Défilement fluide
        }
    };
    ...
    return (
        <div className="home-container">
            ...
            {/* Section "Qu'est-ce que notre plateforme de coaching ?" */}
            ...
            {/* Section "Coachs" avec référence */}
            <section id="coaches" className="coaches" ref={coachesRef}>
                <h2>Nos Coachs</h2>
